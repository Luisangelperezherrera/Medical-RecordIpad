...
- (void)viewDidLoad
{
    ...
    [self addTab:@"Información del Paciente" forViewController:[sb instantiateViewControllerWithIdentifier:@"infoAdicional"]];
    [self addTab:@"Información Adicional" forViewController:[sb instantiateViewControllerWithIdentifier:@"infoPaciente"]];
